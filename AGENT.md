...
```html
<script type="module">
    import { WoxToast, WoxContextMenu } from 'https://cdn.jsdelivr.net/npm/wox-gui@0.1.10/dist/wox-gui.cdn.js';

    WoxToast.success('Hello from CDN!');
</script>
```

Also available via unpkg: `https://unpkg.com/wox-gui@0.1.10/dist/wox-gui.cdn.js`

**Important:** Always pin the version (`@0.1.10`) — unversioned URLs may serve a stale cached version.
