...
<head>
    ...
    <script type="module" src="https://cdn.jsdelivr.net/npm/wox-gui@0.5.1/dist/wox-gui.cdn.js"></script>
</head>
<body>
...
```html
<script type="module">
    import { WoxToast, WoxContextMenu } from 'https://cdn.jsdelivr.net/npm/wox-gui@0.5.1/dist/wox-gui.cdn.js';

    WoxToast.success('Hello from CDN!');
</script>
```

Also available via unpkg: `https://unpkg.com/wox-gui@0.5.1/dist/wox-gui.cdn.js`

**Important:** Always pin the version (`@0.5.1`) — unversioned URLs may serve a stale cached version.
...
This project is indexed by GitNexus as **wox-gui** (1571 symbols, 2246 relationships, 5 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/wox-gui/context` | Codebase overview, check index freshness |
| `gitnexus://repo/wox-gui/clusters` | All functional areas |
| `gitnexus://repo/wox-gui/processes` | All execution flows |
| `gitnexus://repo/wox-gui/process/{name}` | Step-by-step execution trace |
