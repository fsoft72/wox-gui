...
<head>
    ...
    <script type="module" src="https://cdn.jsdelivr.net/npm/wox-gui@0.3.0/dist/wox-gui.cdn.js"></script>
</head>
<body>
...
```html
<script type="module">
    import { WoxToast, WoxContextMenu } from 'https://cdn.jsdelivr.net/npm/wox-gui@0.3.0/dist/wox-gui.cdn.js';

    WoxToast.success('Hello from CDN!');
</script>
```

Also available via unpkg: `https://unpkg.com/wox-gui@0.3.0/dist/wox-gui.cdn.js`

**Important:** Always pin the version (`@0.3.0`) — unversioned URLs may serve a stale cached version.
